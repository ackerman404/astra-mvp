...
; Packages PyInstaller --onedir output into a standard Windows installer
...
; so no extra UninstallDelete entries are needed for app files.

[Code]
// Check if Astra is running before install or uninstall.
// Prompts user to close the app if a running instance is detected.

function IsAppRunning(): Boolean;
var
  ResultCode: Integer;
begin
  // Use tasklist to check for Astra.exe process
  Result := False;
